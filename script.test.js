describe("search the frouts by fruit name", function(){
    let fruit;
    beforeEach(function() {
        fruit = ['Apple', 'Apricot', 'Avocado 🥑', 'Banana', 
        ...
        'Raisin', 'Grapefruit', 'Guava', 'Honeyberry', 'Huckleberry', 'Jabuticaba', 
        'Jackfruit', 'Jambul', 'Juniper berry', 'Kiwifruit', 'Kumquat', 'Lemon', 'Lime', 
